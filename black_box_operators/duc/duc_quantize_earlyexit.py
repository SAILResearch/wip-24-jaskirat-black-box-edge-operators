import onnx
input_path="ResNet101-DUC-12_int8_sptq.onnx"
output_path="ResNet101-DUC-12_int8_sptq_earlyexit_sub_graph.onnx"
input_names=['data']
output_names=['conv5_1']
onnx.utils.extract_model(input_path, output_path, input_names, output_names)
output_path="ResNet101-DUC-12_int8_sptq_decision_sub_graph.onnx"
input_names=['conv5_3']
...
onnx.save(earlyexit_model, "ResNet101-DUC-12_int8_sptq_earlyexit.onnx")