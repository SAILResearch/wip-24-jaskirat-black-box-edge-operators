...
# Load the ONNX model
model = onnx.load('wide-resnet101_int8_sptq_earlyexit.onnx')
...
for node in model.graph.node:
    ...
    if node.name=='/layer3/layer3.12/Add':
...
csv_file_path = "resnet_quantize_earlyexit_partition_intermediate_data_size.csv"
