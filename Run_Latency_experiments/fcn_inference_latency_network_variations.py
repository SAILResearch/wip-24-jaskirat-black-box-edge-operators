...
for operator in operators:
    if operator =="identity":
        for subject in subjects:
            ...
            for multi_tier in multi_tiers:
                ...
                if multi_tier == 'edge-cloud' or multi_tier =='mobile-cloud':
                    for mobile_edge_bandwidth in mobile_edge_bandwidths:
                        for edge_cloud_bandwidth in edge_cloud_bandwidths:
    ...
    if operator =="sptq":
        for subject in subjects:
            ...
            for multi_tier in multi_tiers:
                if multi_tier == 'mobile-cloud' or multi_tier == 'edge-cloud':
                    for mobile_edge_bandwidth in mobile_edge_bandwidths:
                        for edge_cloud_bandwidth in edge_cloud_bandwidths:
                            url, result_file=construct_url_for_sptq(multi_tier, subject, mobile_edge_bandwidth, edge_cloud_bandwidth)
                            with open(result_file,'w') as fd:
                                fd.write('Experiment Results\n')
                            for i in range(6):
                                print("Experiment:",i+1)
                ...
                if multi_tier == 'mobile-edge':
                    for mobile_edge_bandwidth in mobile_edge_bandwidths:
                        url, result_file=construct_url_for_sptq(multi_tier, subject, mobile_edge_bandwidth, '')
                        with open(result_file,'w') as fd:
                            fd.write('Experiment Results\n')
                        for i in range(6):
                            print("Experiment:",i+1)
    ...
    if operator =="earlyexit":
        for subject in subjects:
            for single_tier in single_tiers:
                if single_tier == 'mobile' or single_tier == 'edge':
                    for mobile_edge_bandwidth in mobile_edge_bandwidths:
                        url, result_file=construct_url_for_earlyexit(single_tier, subject, mobile_edge_bandwidth, '')
                        with open(result_file,'w') as fd:
                            fd.write('Experiment Results\n')
                        for i in range(6):
                            print("Experiment:",i+1)
            ...
            for multi_tier in multi_tiers:
                ...
                if multi_tier == 'mobile-edge':
                    for mobile_edge_bandwidth in mobile_edge_bandwidths:
                        url, result_file=construct_url_for_earlyexit(multi_tier, subject, mobile_edge_bandwidth, '')
                        with open(result_file,'w') as fd:
                            fd.write('Experiment Results\n')
                        for i in range(6):
                            print("Experiment:",i+1)
    ...
    if operator == "sptq earlyexit":
        for subject in subjects:
            ...
            for multi_tier in multi_tiers:
                ...
                if multi_tier == 'mobile-edge':
                    for mobile_edge_bandwidth in mobile_edge_bandwidths:
                        url, result_file=construct_url_for_sptq_earlyexit(multi_tier, subject, mobile_edge_bandwidth, '')
                        with open(result_file,'w') as fd:
                            fd.write('Experiment Results\n')
                        for i in range(6):
                            print("Experiment:",i+1)
