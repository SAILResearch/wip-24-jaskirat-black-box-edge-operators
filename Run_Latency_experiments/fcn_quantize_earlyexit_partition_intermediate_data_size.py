...
dataset = os.listdir('coco_100_images')
...
# Load the ONNX model
model = onnx.load('fcn-resnet101-11_int8_sptq_earlyexit.onnx')
...
csv_file_path = "fcn_quantize_earlyexit_partition_intermediate_data_size.csv"
